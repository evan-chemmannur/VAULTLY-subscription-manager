  ...
  if (!isWebGLAvailable) {
    return (
      <div className={`relative h-full w-full overflow-hidden rounded-[28px] border border-[#FFFFFF1A] bg-[radial-gradient(circle_at_30%_20%,rgba(229,9,20,0.18),rgba(15,16,18,0.88)_40%,rgba(4,5,6,1)_100%)] shadow-[0_20px_60px_rgba(0,0,0,0.8)] ${className}`}>
        ...
        <div className="absolute left-6 top-6 h-16 w-16 rounded-2xl border border-[#10B981]/40 bg-[#101214] shadow-[0_0_18px_rgba(229,9,20,0.35)]" />
        <div className="absolute right-8 top-8 h-20 w-20 rounded-full border border-[#10B981]/35 bg-[#1a1d1f]" />
        <div className="absolute inset-x-8 bottom-7 h-12 rounded-2xl border border-[#FFFFFF12] bg-[#0e1114]" />
      </div>
    );
  }
