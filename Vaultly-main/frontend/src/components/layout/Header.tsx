      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative w-64 hidden sm:block">
          ...
          <input
            ...
            className="w-full h-9 pl-9 pr-4 bg-[#121216] border border-white/10 rounded-xl text-xs text-white placeholder-[#666680] focus:outline-none focus:border-[#10B981] focus:ring-1 focus:ring-[#10B981] transition-all"
          />
        </div>
        ...
        <div className="relative">
          <select
            ...
            className="h-9 px-3 bg-[#121216] border border-white/10 rounded-xl text-xs text-white focus:outline-none focus:border-[#10B981] cursor-pointer"
          >
        ...
        {metrics && (
          <div className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 bg-[#1A1A22] border border-white/10 rounded-xl text-xs font-mono font-semibold text-white">
        ...
        <button className="w-9 h-9 rounded-xl bg-[#121216] border border-white/10 flex items-center justify-center text-[#8888A0] hover:text-white transition-colors relative">
