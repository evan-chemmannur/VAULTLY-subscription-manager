...
export const SkeletonCard: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div className={`bg-[#0A0A0C] border border-[#121216] rounded-2xl p-6 animate-pulse ${className}`}>
...
export const SkeletonDashboard: React.FC = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 bg-[#0A0A0C] border border-[#121216] rounded-2xl p-6 h-80 animate-pulse" />
      <div className="bg-[#0A0A0C] border border-[#121216] rounded-2xl p-6 h-80 animate-pulse" />
    </div>
  </div>
);
