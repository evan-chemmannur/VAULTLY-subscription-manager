  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="bg-[#121216] border border-white/10 rounded-2xl p-6 flex items-center justify-between">
        ...
        {saveSuccess && (
          <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#10B981]/20 border border-[#10B981]/40 text-[#34D399] text-xs font-semibold rounded-xl animate-fade-in">
      ...
      <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-10 px-3.5 bg-[#0A0A0C] border border-white/10 rounded-2xl text-sm text-white focus:outline-none focus:border-[#10B981] cursor-pointer"
              >
        ...
        <div className="flex justify-end pt-2">
          <button
            type="submit"
            disabled={isSaving}
            className="inline-flex items-center gap-2 px-6 py-3 bg-[#10B981] hover:bg-[#34D399] text-white font-semibold text-sm rounded-2xl shadow-brand-glow transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
          >
