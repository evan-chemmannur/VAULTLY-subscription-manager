        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-[#8888A0] uppercase mb-1">
              Service Name <span className="text-[#34D399]">*</span>
            </label>
            <input
              type="text"
              value={name}
              ...
              className="w-full h-10 px-3.5 bg-[#0A0A0C] border border-white/10 rounded-2xl text-sm text-white focus:outline-none focus:border-[#10B981]"
            />
            {errors.name && <p className="text-xs text-[#34D399] mt-1 flex items-center gap-1"><AlertCircle className="w-3 h-3" /> {errors.name}</p>}
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2">
              <label className="block text-xs font-semibold text-[#8888A0] uppercase mb-1">
                Cost Amount ($) <span className="text-[#34D399]">*</span>
              </label>
              <input
                type="number"
                step="0.01"
                ...
                placeholder="29.99"
                className="w-full h-10 px-3.5 bg-[#0A0A0C] border border-white/10 rounded-2xl text-sm font-mono text-white focus:outline-none focus:border-[#10B981]"
              />
              {errors.amount && <p className="text-xs text-[#34D399] mt-1 flex items-center gap-1"><AlertCircle className="w-3 h-3" /> {errors.amount}</p>}
            </div>
            ...
            <div>
              ...
              <select
                ...
                className="w-full h-10 px-3 bg-[#0A0A0C] border border-white/10 rounded-2xl text-sm text-white focus:outline-none focus:border-[#10B981] cursor-pointer"
              >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-semibold text-[#8888A0] uppercase mb-1">
                Next Billing Date <span className="text-[#34D399]">*</span>
              </label>
              <input
                type="date"
                value={nextBillingDate}
                onChange={(e) => setNextBillingDate(e.target.value)}
                className="w-full h-10 px-3 bg-[#0A0A0C] border border-white/10 rounded-2xl text-xs font-mono text-white focus:outline-none focus:border-[#10B981]"
              />
              {errors.nextBillingDate && <p className="text-xs text-[#34D399] mt-1">{errors.nextBillingDate}</p>}
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full p-3 bg-[#0A0A0C] border border-white/10 rounded-2xl text-xs text-white placeholder-[#666680] focus:outline-none focus:border-[#10B981]"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-4 border-t border-white/10">
            <button
              type="button"
              onClick={handleClose}
              className="px-4 py-2.5 text-xs font-semibold text-[#8888A0] hover:text-white bg-[#1A1A22] border border-white/10 rounded-2xl transition-colors"
            >
              Cancel
            </button>
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#10B981] hover:bg-[#34D399] text-white text-xs font-semibold rounded-2xl shadow-brand-glow transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
            >
