...
export const DashboardView: React.FC = () => {
  ...
  const DONUT_COLORS = ['#10B981', '#444458', '#2A2A38', '#1A1A24', '#121216'];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-[#121216] border border-[#10B981]/40 rounded-2xl p-6 relative overflow-hidden shadow-brand-glow flex flex-col justify-between">
          <div className="absolute top-0 right-0 left-0 h-1 bg-gradient-to-r from-[#10B981] via-[#34D399] to-transparent" />
          <div>
            <div className="flex items-center justify-between text-[#8888A0] text-xs font-semibold uppercase tracking-wider mb-2">
              <span>Monthly Spend</span>
              <span className="p-1 rounded bg-[#10B981]/15 text-[#34D399]">
            ...
            <p className="text-xs text-[#8888A0] mt-1 flex items-center gap-1">
              <span className="text-[#34D399] font-semibold flex items-center">
        ...
        <div className="bg-[#121216] border border-white/10 rounded-2xl p-6 flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between text-[#8888A0] text-xs font-semibold uppercase tracking-wider mb-2">
              ...
              <span className="p-1 rounded bg-white/5 text-[#10B981]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#121216] border border-white/10 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-xs font-mono text-[#10B981] bg-[#10B981]/10 border border-[#10B981]/30 px-2.5 py-1 rounded-full">
              6 Month Trajectory
            </span>
          </div>
          ...
          <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={spending_trend} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                <defs>
                  <linearGradient id="VaultlyRedGradient" x1="0" y1="0" x2="0" y2="1">
                ...
                />
                <Area type="monotone" dataKey="amount" stroke="#10B981" strokeWidth={2.5} fillOpacity={1} fill="url(#VaultlyRedGradient)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <div className="bg-[#121216] border border-white/10 rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-[#1A1A22] hover:bg-white/10 text-white text-xs font-medium rounded-xl border border-white/10 transition-colors"
          >
                  ...
                  <tr key={sub.id} className="hover:bg-[#1A1A22] transition-colors group">
                    <td className="py-3.5 px-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-xl bg-[#1A1A22] border border-white/10 flex items-center justify-center text-white font-bold text-xs uppercase">
                          {sub.name.charAt(0)}
                        </div>
                        <div>
                    ...
                    <td className="py-3.5 px-4 text-xs font-mono text-[#34D399] flex items-center gap-1">
                    ...
                    <td className="py-3.5 px-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 bg-[#10B981]/15 hover:bg-[#10B981]/30 text-xs text-[#34D399] rounded transition-colors"
                        >
                          Delete
                        </button>
                      </div>
