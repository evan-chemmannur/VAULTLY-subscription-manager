      ...
      <div className="w-full max-w-md rounded-[24px] border border-[#FFFFFF1A] bg-[#121216]/90 p-8 shadow-[0_25px_60px_rgba(0,0,0,0.85)] backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div>
            ...
            <div className={`flex items-center gap-3 rounded-2xl border bg-[#0A0A0C] px-3 py-3 transition focus-within:border-[#10B981] focus-within:shadow-[0_0_12px_rgba(229,9,20,0.25)] ${fieldErrors.identifier ? 'border-[#10B981]/70' : 'border-[#FFFFFF1A]'}`}>
        ...
        <p className="mt-6 text-center text-sm text-[#8888A0]">
          Need an account?{' '}
          <button type="button" onClick={onSwitchToRegister} className="font-semibold text-white underline decoration-[#10B981]/60 underline-offset-4 hover:text-[#E0E0E0]">
            Create one
          </button>
        </p>
      </div>
