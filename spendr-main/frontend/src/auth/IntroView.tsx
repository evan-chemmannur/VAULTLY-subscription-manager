  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#050507] text-white">
      <button
        type="button"
        onClick={onSkip}
        className="absolute right-6 top-6 z-30 rounded-full border border-[#FFFFFF22] bg-[#121216]/80 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#E8E8E8] backdrop-blur transition hover:border-[#10B981]/70 hover:text-white"
      >
        Skip
      </button>
          ...
          >
            {Array.from({ length: 22 }).map((_, index) => (
              <motion.span
                ...
                className="absolute block rounded-full bg-[#10B981]/90"
                style={{
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center justify-center px-5 py-10 text-center">
        <div className="pointer-events-none absolute left-1/2 top-[22%] h-64 w-64 -translate-x-1/2 rounded-full bg-[#10B981]/10 blur-3xl" />
        ...
        <AnimatePresence>
          {showLogo && (
            ...
            >
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[#10B981]/55 bg-[#121216] text-2xl font-black text-[#10B981] shadow-[0_0_26px_rgba(229,9,20,0.45)]">
                S
              </div>
              <div className="text-4xl font-black tracking-[0.22em] text-white sm:text-5xl">Vaultly</div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <AnimatePresence>
          {showText && (
            ...
            >
              ...
              <div className="mx-auto h-px w-20 bg-[#10B981]/75" />
            </motion.div>
          )}
        </AnimatePresence>
        ...
        >
          <div className="pointer-events-none absolute h-[300px] w-[300px] rounded-full bg-[#10B981]/12 blur-3xl" />
