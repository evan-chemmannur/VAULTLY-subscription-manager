    ...
    <div className="flex min-h-screen items-center justify-center bg-[#000000] px-6 py-10 text-white">
      <div className="w-full max-w-md rounded-[24px] border border-[#FFFFFF1A] bg-[#121216]/90 p-8 shadow-[0_25px_60px_rgba(0,0,0,0.85)] backdrop-blur-xl">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-5 flex h-14 w-14 items-center justify-center rounded-2xl border border-[#10B981]/50 bg-[#0A0A0C] text-2xl font-black text-[#10B981] shadow-[0_0_25px_rgba(229,9,20,0.3)]">
            S
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-white">Create account</h1>
          <p className="mt-2 text-sm text-[#8888A0]">Start tracking your subscriptions with Vaultly.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          {!hasFieldErrors && formError && (
            <div className="rounded-xl border border-[#10B981]/40 bg-[#10B981]/10 px-3 py-2 text-sm text-[#FFB2B2]">{formError}</div>
          )}

          <div>
            <label className="mb-2 block text-xs uppercase tracking-[0.18em] text-[#8888A0]">Full Name</label>
            <div className={`flex items-center gap-3 rounded-2xl border bg-[#0A0A0C] px-3 py-3 transition focus-within:border-[#10B981] focus-within:shadow-[0_0_12px_rgba(229,9,20,0.25)] ${fieldErrors.name ? 'border-[#10B981]/70' : 'border-[#FFFFFF1A]'}`}>
          ...
          <div>
            ...
            <div className={`flex items-center gap-3 rounded-2xl border bg-[#0A0A0C] px-3 py-3 transition focus-within:border-[#10B981] focus-within:shadow-[0_0_12px_rgba(229,9,20,0.25)] ${fieldErrors.email ? 'border-[#10B981]/70' : 'border-[#FFFFFF1A]'}`}>
          ...
          <div>
            ...
            <div className={`flex items-center gap-3 rounded-2xl border bg-[#0A0A0C] px-3 py-3 transition focus-within:border-[#10B981] focus-within:shadow-[0_0_12px_rgba(229,9,20,0.25)] ${fieldErrors.password ? 'border-[#10B981]/70' : 'border-[#FFFFFF1A]'}`}>
          ...
          <div>
            ...
            <div className={`flex items-center gap-3 rounded-2xl border bg-[#0A0A0C] px-3 py-3 transition focus-within:border-[#10B981] focus-within:shadow-[0_0_12px_rgba(229,9,20,0.25)] ${fieldErrors.confirm_password ? 'border-[#10B981]/70' : 'border-[#FFFFFF1A]'}`}>
              <Lock className="h-4 w-4 text-[#8888A0]" />
              <input
                type={showPassword ? 'text' : 'password'}
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-2xl bg-[#10B981] px-4 py-3 text-sm font-semibold uppercase tracking-[0.12em] text-white transition hover:bg-[#34D399] disabled:cursor-not-allowed disabled:opacity-70"
          >
        ...
        <p className="mt-6 text-center text-sm text-[#8888A0]">
          ...
          <button type="button" onClick={onSwitchToLogin} className="font-semibold text-white underline decoration-[#10B981]/60 underline-offset-4 hover:text-[#E0E0E0]">
            Sign in
          </button>
        </p>
      </div>
